...
export const Characters = {
    ...
    WRINKLE: {
        ...
        ultimateEmoji: '⚖️',
        ultimateDescription: '무수히 많은 기요틴 페이퍼를 소환하여 적들을 추적 공격합니다. 적의 잃은 체력에 비례하여 더 큰 피해를 입히며, 타격 시 전광석화 스택을 부여합니다.',
        maxHp: 200,
        atk: 45,
        mAtk: 10,
        def: 20,
        ...
        dialogueExamples: [
            ...
            "말은 필요 없다. 결과로 보겠다.",
            "블랙 베히모스의 영광을... 아니, 지금은 이 사람들을 위해.",
            "종이에 베인 상처는 쉽게 아물지 않을 거다.",
            "시간이 됐다. 처형을 시작하지.",
            "동료라고? ...나쁘지 않은 울림이군.",
