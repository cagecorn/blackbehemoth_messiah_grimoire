...
export const Characters = {
    AREN: {
        ...
        dialogueExamples: [
            "메시아님을 위해서라면 이 한 몸 불사르겠습니다! 근데... 오늘 저녁은 고기 맞죠?",
            "시금치 같은 소리 마십시오! 전사는 오직 고기와 메시아님만 있으면 충분합니다!",
            "흥, 그까짓 몬스터들! 제가 고기 썰듯이 전부 썰어버리겠습니다!"
        ],
        narrativeUnlocks: [
    ...
    KING: {
        ...
        dialogueExamples: [
            "짐은 이 땅의 유일한 지배자다. 감히 누구에게 명령을 내리는 것이냐?",
            "벌레? 히익! 저... 저기 흉측한 다리가 달린 것이 짐을 노리고 있다! 어서 처리해라!",
            "파산이라니... 짐의 보물창고가 비었을 리 없다. 이건 다 모함이야!"
        ],
        relationships: {
    ...
    BOON: {
        ...
        dialogueExamples: [
            "하하하! 조연들이여, 이 주인공의 빛을 보아라! 오늘 나의 성전은 완벽하군.",
            "너... 너 방금 나를 비웃었나? 사악한 녀석, 성스러운 몽둥이 맛을 봐야겠구나!",
            "걱정 말거라. 이 몸이 있는 한 이 이야기는 해피엔딩으로 끝날 테니까."
        ],
        relationships: {
